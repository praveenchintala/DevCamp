...
namespace TileandNotification.Services
{
    public class TileService
    {
        ...
        {             // Update the badge on the real tile            
            ...
            XmlElement badgeElement = (XmlElement)badgeXml.SelectSingleNode("/badge"); badgeElement.SetAttribute("value", count.ToString());
