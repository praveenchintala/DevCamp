    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnActivated(IActivatedEventArgs args)
        {
            ...
            {         // Create a Frame to act as the navigation context and navigate to the first page         
                ...
                switch (args.Kind) { case ActivationKind.VoiceCommand: HandleVoiceCommand(args, rootFrame); break; default: break; }
            Window.Current.Activate();
        ...
        private void HandleVoiceCommand(IActivatedEventArgs args, Frame frame)
        {
            ...
            var speechRecognitionResult = commandArgs.Result; var command = speechRecognitionResult.Text;
